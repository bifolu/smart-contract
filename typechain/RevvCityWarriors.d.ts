...
interface RevvCityWarriorsInterface extends ethers.utils.Interface {
  functions: {
...
export class RevvCityWarriors extends BaseContract {
  ...
  interface: RevvCityWarriorsInterface;
